      ...
      <div style="padding:0 10px;">
        <el-form :model="loginForm" :rules="rules" ref="loginForm" label-width="0px">
          <el-form-item prop="name">
            <el-input type="text" placeholder="用户名" v-model="loginForm['name']"></el-input>
          </el-form-item>
          <el-form-item prop="password">
            <el-input :type="passwordType" placeholder="密码" v-model="loginForm['password']">
          ...
          <el-form-item prop="vertifyCode">
            <el-input type="text" placeholder="验证码" v-model="loginForm['vertifyCode']">
              <template slot="append">
